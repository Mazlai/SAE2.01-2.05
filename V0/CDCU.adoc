...
ex : débiter un compte avoir un solde positif (retirer moins que notre solde) etc.

== Besoins non fonctionnels

-Faire des phrases-

L'application devra être hautement sécurisée car infos confidentielles
Tourner en réseau
Etre compatible avec tous les systèmes d'exploitation
L'application devra être disponible sur mobile ou autre plateforme
