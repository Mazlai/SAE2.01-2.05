...
Afin de pouvoir rendre inactif d'un client, il faudra s'assurer dans un premier temps que vous êtes bien connecté en tant que chef d'agence et non de guichetier car seulement le chef d'agence peut rendre inactif un client. 
