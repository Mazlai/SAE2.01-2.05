...
Suite à l'implémentation de la deuxième version du diagramme des UC, nous pouvons observer que le chef d'agence peut désormais sous la demande du client, effectuer trois nouvelles actions à savoir : effectuer un débit exceptionnel | simuler un emprunt | simuler une assurance d'emprunt.
