...
On se contentera seulement d'afficher la mensualité que le client devra, tout en dépendant de si celui-ci possède une assurance. Car oui, l'assurance en question protègera le client tout au long du crédit, bien qu'il ne soit pas obligatoire.
...
_Inspiré en grande partie des classes__ ``ClientEditorPane.java`` _et_ ``ClientEditorPaneController.java``.
