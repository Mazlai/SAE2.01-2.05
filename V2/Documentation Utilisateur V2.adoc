...
Une nouvelle fenêtre va s'ouvrir et vous pourrez modifier les champs qui vous intéressent comme le montant du prélèvement, la date recurrente ou encore le bénéficiaire

image::/V2/images/pre5.png[Etape 2 pour modifier un prélèvement]
